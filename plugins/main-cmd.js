...
console.log(`☠️BEOWULF☠️-MD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from, contextInfo, reply }) => {
    try {
        ...
        let envSettings = `╭━━━〔 *☠️BEOWULF☠️-MD-ENV* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *𝔼ℕ𝕍 𝕊𝔼𝕋𝕋𝕀ℕ𝔾𝕊 📡*
┃▸└───────────···๏
╰────────────────┈⊷
...
async (conn, mek, m, { from }) => {
    try {
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+2348030559356', '') + '+2348030559356@s.whatsapp.net'], // Mention the owner
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_☠️BEOWULF☠️-MD..._*'  }, { quoted: mek } )
...
try{
let dec = `> ☠️BEOWULF☠️-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ ☠️BEOWULF☠️-MD REPO: ${bot.REPO_LINK} 
┃
